...
// TestDecodeint32 makes sure we can decode 64 bit values into each destination type
...
// TestDecodeint16 makes sure we can decode 64 bit values into each destination type
